        ...
        with conn.cursor() as cur:
            for item in data:
                ...
                try:
                    ...
                    print(f"[ERRO] Erro ao processar produto {product_id} da categoria {department}: {e}", flush=True)
                    cur.execute("ROLLBACK TO SAVEPOINT sp") # desfaz apenas as operações do produto atual, mantendo o progresso dos outros produtos da página
                    continue
